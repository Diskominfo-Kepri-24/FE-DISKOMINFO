    ...
    <>
      <div className="overflow-hidden rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto mt-12 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-[176px] sm:p-3">
          ...
          <div className="mt-6 flex justify-center">
            <button className="px-6 py-2 rounded-[7px] bg-primary text-white hover:bg-opacity-90">
              Save
            </button>
          </div>
        </div>
