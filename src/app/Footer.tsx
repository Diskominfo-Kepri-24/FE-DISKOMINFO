...
import { fetchStatistics, logVisit } from '../utils/visitTracker';
...
const Footer: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Polling every 60 seconds to update statistics
    ...
    if (statistics === null) return <footer className="bg-blue-950">Loading...</footer>;
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-6 lg:max-w-sm">
                            <p className="text-sm font-semibold text-white">
                                Alamat: Pusat Pemerintahan Provinsi Kepulauan Riau Istana Kota Piring Gedung Sultan Mahmud Riayat Syah, Dompak, Bukit Bestari, 29124 Tanjungpinang - Kepulauan Riau - Indonesia
                            </p>
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-2">
                            ...
                            <div className="flex justify-between text-sm items-center text-white">
                                ...
                                <div className="flex-grow border-t border-dashed border-gray-500 mx-2"></div>
                                <p>{statistics.this_month}</p>
                            </div>
                            <div className="flex justify-between text-sm items-center text-white">
                                <p className="font-semibold">Bulan Kemarin</p>
                                <div className="flex-grow border-t border-dashed border-gray-500 mx-2"></div>
                                <p>{statistics.last_month}</p>
                            </div>
                        </div>
                    </div>
                </div>
