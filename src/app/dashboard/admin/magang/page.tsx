...
import TablePengajuanMagang from '@/components/Tables/TablePengajuanMagang';
...
const PengajuanMagang = () => {
  ...
  return (
    <DefaultLayout>
         <h1 className='text-xl font-bold text-black dark:text-white'>Pengajuan Magang</h1>
         <TablePengajuanMagang/>
    </DefaultLayout>
  );
};
